        ...
        <div style={{ height: '300px', width: '100%' }}>
          <ResponsiveContainer>
            <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
              ...
              <XAxis type="number" dataKey="rpm" name="RPM" stroke="#888" domain={[0, 5000]} />
              <YAxis type="number" dataKey="bsfc" name="BSFC" stroke="#888" />
              ...
              <Scatter name="BSFC Curve" data={bsfcData} fill="var(--accent-purple)" />
            </ScatterChart>
          </ResponsiveContainer>
        </div>
      </div>
        ...
        <div style={{ height: '300px', width: '100%' }}>
          <ResponsiveContainer>
            <LineChart data={dataHistory} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
              ...
              <Line type="monotone" dataKey="cht_1_c" stroke="#ff7300" dot={false} strokeWidth={2} />
              <Line type="monotone" dataKey="cht_4_c" stroke="#82ca9d" dot={false} strokeWidth={2} />
            </LineChart>
          </ResponsiveContainer>
        </div>
      </div>
        ...
        <div style={{ height: '200px', width: '100%' }}>
          <ResponsiveContainer>
            <AreaChart data={dataHistory} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
              ...
              <RechartsTooltip contentStyle={{ backgroundColor: 'rgba(20,20,25,0.9)', borderColor: 'rgba(255,255,255,0.1)' }} />
              <Area type="monotone" dataKey="rul_hours" stroke="var(--accent-blue)" fillOpacity={1} fill="url(#colorRul)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </div>
